...
export default function PlaceholderPage({
  ...
  if (role === "student") {
    ...
    if (title === "My Profile") return <StudentResourcePage title="My profile" resource="profile" />;
  }
  ...
  if (role === "parent") {
    ...
    if (title === "My Profile") return <ParentResourcePage title="My profile" resource="profile" />;
  }
