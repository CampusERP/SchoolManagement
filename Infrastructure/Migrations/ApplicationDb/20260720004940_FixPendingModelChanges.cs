        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OverallPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    OverallGrade = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    IsLocked = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasParentPortal = table.Column<bool>(type: "bit", nullable: false),
                    HasExamModule = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NotificationBatchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AssignmentSubmissionDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentSubmissionDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentSubmissionDocuments_AssignmentSubmissions_AssignmentSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_SchoolId_DueDate",
                table: "Assignments",
                columns: new[] { "SchoolId", "DueDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_SchoolId_TeachingAssignmentId",
                table: "Assignments",
                columns: new[] { "SchoolId", "TeachingAssignmentId" });

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmissionDocuments_AssignmentSubmissionId_DocumentId",
                table: "AssignmentSubmissionDocuments",
                columns: new[] { "AssignmentSubmissionId", "DocumentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmissions_AssignmentId_StudentEnrollmentId",
                table: "AssignmentSubmissions",
                columns: new[] { "AssignmentId", "StudentEnrollmentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentSubmissions_StudentEnrollmentId",
                table: "AssignmentSubmissions",
                column: "StudentEnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_AttendanceSessionId_StudentEnrollmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_ClassScheduleId_Date",
                table: "AttendanceSessions",
                columns: new[] { "ClassScheduleId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurriculumSubjects_SchoolId",
                table: "CurriculumSubjects",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_CurriculumSubjects_SchoolId_GradeLevelId_SubjectId",
                table: "CurriculumSubjects",
                columns: new[] { "SchoolId", "GradeLevelId", "SubjectId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_ExamScheduleId_StudentEnrollmentId",
                table: "ExamResults",
                columns: new[] { "ExamScheduleId", "StudentEnrollmentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_SchoolId_TermId_SubjectId",
                table: "Exams",
                columns: new[] { "SchoolId", "TermId", "SubjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_ExamSchedules_ExamId_ClassRoomId",
                table: "ExamSchedules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationBatches_SchoolId_CreatedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTemplates_SchoolId_Type",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportCards_SchoolId_TermId",
                table: "ReportCards",
                columns: new[] { "SchoolId", "TermId" });

            migrationBuilder.CreateIndex(
                name: "IX_ReportCards_StudentEnrollmentId_TermId",
                table: "ReportCards",
                columns: new[] { "StudentEnrollmentId", "TermId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_OneActivePerSchool",
                table: "Subscriptions",
                column: "SchoolId",
                unique: true,
